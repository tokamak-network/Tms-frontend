...
const Footer = () => {
  return (
    <footer className="fixed bottom-0 left-0 right-0 p-2 lg:p-4 flex flex-col lg:flex-row justify-between items-center mx-2 lg:ml-5 lg:mr-10 text-xs sm:text-sm lg:text-base">
      <div className="text-left flex items-center space-x-1 lg:space-x-2 mb-2 lg:mb-0">
        <img src={emailLogo.src} alt="Email Logo" className="h-4 w-4 sm:h-5 sm:w-5 lg:h-7 lg:w-7 inline" />
      ...
      <div className="flex flex-wrap justify-center space-x-3 sm:space-x-4 lg:space-x-5">
        <a href="https://x.com/tokamak_network" target="_blank" rel="noopener noreferrer">
          <img src={XLogo.src} alt="Twitter Logo" className="h-3 w-3 sm:h-4 sm:w-4 lg:h-4 lg:w-4 inline" />
        </a>
        <a href="https://github.com/tokamak-network" target="_blank" rel="noopener noreferrer">
          <img src={githubLogo.src} alt="GitHub Logo" className="h-4 w-4 sm:h-5 sm:w-5 lg:h-5 lg:w-5 inline" />
        </a>
        <a href="https://medium.com/tokamak-network" target="_blank" rel="noopener noreferrer">
          <img src={mediumLogo.src} alt="Medium Logo" className="h-3 w-5 sm:h-4 sm:w-6 lg:h-4 lg:w-7 inline" />
        </a>
        <a href="https://t.me/tokamak_network" target="_blank" rel="noopener noreferrer">
          <img src={tgLogo.src} alt="Telegram Logo" className="h-4 w-4 sm:h-5 sm:w-5 lg:h-5 lg:w-5 inline" />
        </a>
        <a href="https://discord.com/invite/6wJ8HAA2nD" target="_blank" rel="noopener noreferrer">
          <img src={discordLogo.src} alt="Discord Logo" className="h-5 w-5 sm:h-6 sm:w-6 lg:h-7 lg:w-7 inline" />
        </a>
        <a
