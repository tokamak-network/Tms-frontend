  ...
  return (
    <footer className='fixed bottom-0 left-0 right-0 p-4 flex justify-between items-center ml-5 mr-10'>
      <div className='text-left flex items-center space-x-2'>
        <Image src={emailLogo.src} alt='Email Logo' className='h-7 w- 7inline' />
        <a
      ...
      <div className='flex space-x-5'>
        <a
          ...
          rel='noopener noreferrer'
        >
          <Image src={XLogo.src} alt='Twitter Logo' className='h-4 w-4 inline' />
        </a>
        <a
        ...
        <a
          href='https://discord.com/invite/6wJ8HAA2nD'
          target='_blank'
          rel='noopener noreferrer'
        >
          <Image
